...
export default function SectorSmallMultiples({
  sectors,
}: {
          ...
          <div className="panel" key={s.sector}>
            ...
            <div style={{ marginTop: 8 }}>
              ...
              <div className="bar-frame">
                <div
                  className="bar-fill"
                  style={{ width: x(s.totalDisbursementM) }}
                />
              </div>
            ...
            <div style={{ marginTop: 8 }}>
              ...
              <div
                className="hstack"
                role="figure"
                aria-label="Jobs per million US$"
              >
                <strong style={{ color: "var(--accent-4)" }}>
                  {formatNumberCompact(jobsPerM)}
                </strong>
              </div>
            </div>
          </div>
